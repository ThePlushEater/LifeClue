...
/*
  ...
  Licensed under the MIT @license.
*/
(function(n,t){typeof define=="function"&&define.amd?define(["underscore","backgrid","moment"],t):typeof exports=="object"?module.exports=t(require("underscore"),require("backgrid"),require("moment")):t(n._,n.Backgrid,n.moment)})(this,function(n,t,i){var r=t.Extension.MomentFormatter=function(t){n.extend(this,this.defaults,t)},u;r.prototype=new t.CellFormatter;n.extend(r.prototype,{defaults:{modelInUnixOffset:!1,modelInUnixTimestamp:!1,modelInUTC:!0,modelLang:i.locale(),modelFormat:i.defaultFormat,displayInUnixOffset:!1,displayInUnixTimestamp:!1,displayInUTC:!0,displayLang:i.locale(),displayFormat:i.defaultFormat},fromRaw:function(n){if(n==null)return"";var t=this.modelInUnixOffset?i(n):this.modelInUnixTimestamp?i.unix(n):this.modelInUTC?i.utc(n,this.modelFormat,this.modelLang):i(n,this.modelFormat,this.modelLang);return this.displayInUnixOffset?+t:this.displayInUnixTimestamp?t.unix():(this.displayLang&&t.lang(this.displayLang),this.displayInUTC?t.utc():t.local(),t.format(this.displayFormat))},toRaw:function(n){var t=this.displayInUnixOffset?i(+n):this.displayInUnixTimestamp?i.unix(+n):this.displayInUTC?i.utc(n,this.displayFormat,this.displayLang):i(n,this.displayFormat,this.displayLang);if(t&&t.isValid())return this.modelInUnixOffset?+t:this.modelInUnixTimestamp?t.unix():(this.modelLang&&t.lang(this.modelLang),this.modelInUTC?t.utc():t.local(),t.format(this.modelFormat))}});u=t.Extension.MomentCell=t.Cell.extend({editor:t.InputCellEditor,className:"moment-cell",formatter:r,initialize:function(t){u.__super__.initialize.apply(this,arguments);var i=r.prototype.defaults,f=n.keys(i),e=n.pick(this,f),o=n.pick(t,f);n.extend(this.formatter,i,e,o);this.editor=this.editor.extend({attributes:n.extend({},this.editor.prototype.attributes||this.editor.attributes||{},{placeholder:this.formatter.displayFormat})})}});n.extend(u.prototype,r.prototype.defaults)});__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(t){function i(n){if(i._instance)throw new Error("Error: Instantiation failed: Use View.getInstance() instead of new.");i._instance=this;t.call(this,n)}return __extends(i,t),i.setElement=function(n){i._instance.setElement(n.el)},i.getInstance=function(){return i._instance},i.prototype.render=function(){},i.prototype.loadBasePageLayout=function(){var t=this,i=_.template(n.Setting.getInstance().getPageBaseLayoutTemplate()),r={title:n.Setting.getInstance().getSiteName(),status:n.Setting.getInstance().nonAvailableText()};t.$el.html(i(r));t.addEventListener()},i.prototype.loadHomePageLayout=function(){var t=this;console.log("loadHomePageLayout");t.mapView=n.MapFactory.getInstance().create(1,t.$("#panel-body"));t.mapView.render();t.wingView=n.WingFactory.getInstance().create(1,t.$("#panel-wing"));t.wingView.render();t.markerView=new n.MarkerView},i.prototype.loadGamePageLayout=function(){console.log("loadGamePageLayout");var t=this;t.mapView=n.MapFactory.getInstance().create(1,t.$("#panel-body"));t.mapView.render();t.wingView=n.WingFactory.getInstance().create(2,t.$("#panel-wing"));t.wingView.render();t.markerView=new n.MarkerView},i.prototype.getMapView=function(){return this.mapView},i.prototype.getWingView=function(){return this.wingView},i.prototype.getMarkerView=function(){return this.markerView},i.prototype.addEventListener=function(){var n=this;n.$("#menu-header").on("click",function(){n.getWingView().getIsActive()?n.getWingView().hide():n.getWingView().show()})},i.prototype.setStatusMessage=function(t){var i=this;i.$("#panel-status").html(t);clearTimeout(i.msgTimeout);i.msgTimeout=setTimeout(function(){i.$("#panel-status").html("")},n.Setting.getInstance().getStatusMessageDuration())},i._instance=new i,i}(Backbone.View);n.View=t}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){(function(n){n[n.NONE=0]="NONE";n[n.MAIN=1]="MAIN";n[n.SUB=2]="SUB"})(n.MapViewType||(n.MapViewType={}));var i=n.MapViewType,t=function(t){function i(i,r){var f=this,u;t.call(this,r);this.createMap=function(t){console.log("MAP CREATE!!");var i=f;i.leafletMap==undefined&&(i.setLocation(new L.LatLng(t.coords.latitude,t.coords.longitude)),i.leafletMap=L.map(i.$el[0].id,{closePopupOnClick:!0,zoomControl:!1,doubleClickZoom:!0,touchZoom:!0,zoomAnimation:!0,markerZoomAnimation:!0}).setView(i.location,i.zoom),L.tileLayer(n.Setting.getInstance().getTileMapAddress(),{minZoom:n.Setting.getInstance().getMinZoomLevel(),maxZoom:n.Setting.getInstance().getMaxZoomLevel()}).addTo(i.leafletMap),i.leafletMap.invalidateSize(!1),i.leafletMap.whenReady(i.afterCreateMap),i.$(".leaflet-control-attribution.leaflet-control").html(""))};this.afterCreateMap=function(){var t=f;t.createBasicMapControl();n.View.getInstance().getMarkerView().attachToMap(t.leafletMap)};this.updateMap=function(n){var t=f;t.setLocation(new L.LatLng(n.coords.latitude,n.coords.longitude));t.leafletMap!=undefined&&t.leafletMap.setView(t.location,t.zoom)};u=this;u.setElement(r.el);u.viewType=i;u.zoom=n.Setting.getInstance().getDefaultZoomLevel()}return __extends(i,t),i.prototype.render=function(){var n=this;n.leafletMap==undefined?navigator.geolocation&&navigator.geolocation.getCurrentPosition(n.createMap):n.leafletMap.invalidateSize(!1)},i.prototype.update=function(){var n=this},i.prototype.createBasicMapControl=function(){var t=this,i=_.template(n.Setting.getInstance().getMapBasicControlLayoutTemplate());t.$(".leaflet-top.leaflet-left").html(i({}));t.addEventListener()},i.prototype.addEventListener=function(){var n=this;n.$(".control-button").on("mouseenter",function(){n.SetIsMapPanZoomAvailable(!1)});n.$(".control-button").on("touchenter",function(){n.SetIsMapPanZoomAvailable(!1)});n.$(".control-button").on("touchstart",function(){n.SetIsMapPanZoomAvailable(!1)});n.$(".control-button").on("mouseleave",function(){n.SetIsMapPanZoomAvailable(!0)});n.$(".control-button").on("touchend",function(){n.SetIsMapPanZoomAvailable(!0)});n.$(".control-button.locate").on("click",function(){n.leafletMap.setView(n.location,n.zoom)});n.leafletMap.on("movestart",function(){});n.leafletMap.on("zoomend",function(){n.zoom=n.leafletMap.getZoom()})},i.prototype.updateMapToCurLocation=function(){var n=this;n.leafletMap.setView(n.location,n.zoom)},i.prototype.getMap=function(){return this.leafletMap},i.prototype.setLocation=function(n){var t=this;t.location=n},i.prototype.getLocation=function(){return this.location},i.prototype.setMapZoom=function(n){var t=this;t.zoom=n},i.prototype.getMapZoom=function(){return this.leafletMap.getZoom()},i.prototype.getMapCenter=function(){return this.leafletMap.getCenter()},i.prototype.getMapBounds=function(){return this.leafletMap.getBounds()},i.prototype.SetIsMapPanZoomAvailable=function(n){var t=this;n?(t.leafletMap.dragging.enable(),t.leafletMap.touchZoom.enable(),t.leafletMap.doubleClickZoom.enable(),t.leafletMap.scrollWheelZoom.enable()):(t.leafletMap.dragging.disable(),t.leafletMap.touchZoom.disable(),t.leafletMap.doubleClickZoom.disable(),t.leafletMap.scrollWheelZoom.disable())},i}(Backbone.View);n.MapView=t}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){(function(n){n[n.NONE=0]="NONE";n[n.SELECTCHARACTER=1]="SELECTCHARACTER";n[n.NOTE=2]="NOTE";n[n.SHOWCARD=3]="SHOWCARD"})(n.WingViewType||(n.WingViewType={}));var i=n.WingViewType,t=function(t){function i(n,i){t.call(this,i);var r=this;r.setElement(i.el);r.viewType=n}return __extends(i,t),i.prototype.render=function(){var t=this,i,r;t.viewType==1?(t.$el.css({height:$("#panel-body").height()}),i=_.template(n.Setting.getInstance().getWingCharacterSelectTemplate()),r={detect:n.Setting.getInstance().getDetectGeoLocationText(),select:n.Setting.getInstance().getSelectYourCharacterText(),message:n.Setting.getInstance().nonAvailableText(),character1:n.Setting.getInstance().getCharacter1Name(),character2:n.Setting.getInstance().getCharacter2Name(),character3:n.Setting.getInstance().getCharacter3Name(),character4:n.Setting.getInstance().getCharacter4Name(),character5:n.Setting.getInstance().getCharacter5Name(),character6:n.Setting.getInstance().getCharacter6Name(),start:n.Setting.getInstance().getStartGameText()},t.$el.html(i(r)),n.View.getInstance().setStatusMessage("Welcome to <b>LifeClue<\/b>. Please select your character."),t.addEventListener()):t.viewType==2&&setTimeout(function(){var i=_.template(n.Setting.getInstance().getWingPlayNoteTemplate()),r={location:n.Setting.getInstance().getClaimLocationText(),locations:n.Controller.getInstance().getLocations(),characters:n.Controller.getInstance().getCharacters(),weapons:n.Controller.getInstance().getWeapons()};t.$el.html(i(r));t.addEventListener()},500);t.show();t.$el.css({height:$("#panel-body").height()})},i.prototype.update=function(){var t=this,r=n.Controller.getInstance().getGame(),i;if(t.viewType==1){if(r!=undefined){for(i=1;i<=6;i++)r.get("c"+i+"s")==0?(t.$("#c"+i+"s").removeClass("disabled"),t.$("#c"+i+"s").removeClass("selected")):n.Controller.getInstance().getCharacterId()=="c"+i+"s"?(t.$("#c"+i+"s").removeClass("disabled"),t.$("#c"+i+"s").addClass("selected"),t.setMessage("You selected '"+t.$("#c"+i+"s").html()+"'"),n.View.getInstance().setStatusMessage("You selected '"+t.$("#c"+i+"s").html()+"'")):(t.$("#c"+i+"s").addClass("disabled"),t.$("#c"+i+"s").removeClass("selected"));n.Controller.getInstance().getCharacterId()=="c6s"?t.$("#start-game").removeClass("hidden"):t.$("#start-game").addClass("hidden")}}else t.viewType==2},i.prototype.setMessage=function(n){var t=this;t.$("#message").html(n)},i.prototype.show=function(){var t=this;clearTimeout(t.timeOut);t.$el.removeClass("hidden");t.timeOut=setTimeout(function(){t.$el.addClass("show")},n.Setting.getInstance().getWingViewShowDelay());t.bActive=!0},i.prototype.hide=function(){var t=this;t.bActive=!1;clearTimeout(t.timeOut);t.$el.removeClass("show");t.timeOut=setTimeout(function(){t.$el.addClass("hidden")},n.Setting.getInstance().getWingViewShowDelay())},i.prototype.getIsActive=function(){return this.bActive},i.prototype.getClosestLocation=function(){var i=n.Controller.getInstance().getLocations(),r=n.View.getInstance().getMapView().getLocation(),t=i.models[0],u=distance(r,new L.LatLng(t.get("latitude"),t.get("longitude")));return i!=undefined&&$.each(i.models,function(n,i){var f=distance(r,new L.LatLng(i.get("latitude"),i.get("longitude")));f<u&&(t=i,u=f)}),t},i.prototype.getIsLocationCloseEnough=function(t){var i=n.View.getInstance().getMapView().getLocation(),r=distance(i,new L.LatLng(t.get("latitude"),t.get("longitude")));return r<t.get("radius")?!0:!1},i.prototype.addEventListener=function(){var t=this;t.$("#finish-turn").off("click");t.$("#finish-turn").on("click",function(){t.$("#finish-turn").off("click");$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"finishturn.php",type:"POST",data:{id:1},success:function(i){i==1?n.View.getInstance().setStatusMessage("Your turn ends. Please find other place."):(n.View.getInstance().setStatusMessage("Unexpected Error. Please try again."),t.addEventListener())},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");t.addEventListener()}})});t.$("#submit-show-card").off("click");t.$("#submit-show-card").on("click",function(){t.$("#submit-show-card").off("click");var i=$("#show-card option:selected").attr("data-card");i==undefined?n.View.getInstance().setStatusMessage("Please choose a card to show <b>"+n.Controller.getInstance().getGame().getCharacterMakingSuggestion().get("name")+"<\/b>."):$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"showcard.php",type:"POST",data:{id:1,sc:i},success:function(i){i==1?n.View.getInstance().setStatusMessage("You showed your card to <b>"+n.Controller.getInstance().getGame().getCharacterMakingSuggestion().get("name")+"<\/b>."):(n.View.getInstance().setStatusMessage("Unexpected Error. Please try again."),t.addEventListener())},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");t.addEventListener()}})});t.$("#submit-guess").off("click");t.$("#submit-guess").on("click",function(){t.$("#submit-guess").off("click");var i=$("#guess-location option:selected").attr("data-card"),r=$("#guess-suspect option:selected").attr("data-card"),u=$("#guess-weapon option:selected").attr("data-card");i==undefined||r==undefined||u==undefined?n.View.getInstance().setStatusMessage("Please make a selection."):(t.$("#submit-guess").off("click"),$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"submitsuggestion.php",type:"POST",data:{id:1,sg:i+","+r+","+u},success:function(i){i==1?n.View.getInstance().setStatusMessage("You submit your suggestion. Please wait other's response."):(n.View.getInstance().setStatusMessage("Unexpected Error. Please try again."),t.addEventListener())},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");t.addEventListener()}}))});t.$("#claim-location").off("click");t.$("#claim-location").on("click",function(){t.$("#claim-location").off("click");var i=t.getClosestLocation(),r=t.getIsLocationCloseEnough(i);r?$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"claimlocation.php",type:"POST",data:{id:1,character:n.Controller.getInstance().getCharacterId().charAt(1),location:i.get("id").charAt(1)},success:function(r){r==1?(n.View.getInstance().setStatusMessage("You successfully claim your location at "+i.get("name")+"."),setTimeout(function(){n.View.getInstance().setStatusMessage("Please select your suggestion.")},3e3),t.showSelectionMenu(i)):r==2?(n.View.getInstance().setStatusMessage("Already visited this place in previous turn. Please claim other location."),t.addEventListener()):(n.View.getInstance().setStatusMessage("Someone already claimed. Wait untill he/she finishes his turn."),t.addEventListener())},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");t.addEventListener()}}):(n.View.getInstance().setStatusMessage("You're not close enough to "+i.get("name")+" for claiming location."),t.addEventListener())});t.$("#start-game").off("click");t.$("#start-game").on("click",function(){var r,e;t.$("#start-game").off("click");var s=n.Controller.getInstance().pickCrime(),i=[],h=n.Controller.getInstance().getLocations();$.each(h.models,function(n,t){t.get("bAnswer")==0&&i.push(t)});r=n.Controller.getInstance().getCharacters();$.each(r.models,function(n,t){t.get("bAnswer")==0&&i.push(t)});e=n.Controller.getInstance().getWeapons();$.each(e.models,function(n,t){t.get("bAnswer")==0&&i.push(t)});i=shuffle(i);var o=n.Controller.getInstance().getGame().getNumPlayers(),f=Math.floor(i.length/o),c=i.length-f*o,u=0;$.each(r.models,function(n,t){var r,e;if(t.get("bActive")==1)if(n<c){for(r="",e=0;e<=f;e++)r+=i[u].get("id")+",",u++;r=r.substr(0,r.length-1);t.set({cardsInHand:r})}else{for(r="",e=0;e<f;e++)r+=i[u].get("id")+",",u++;r=r.substr(0,r.length-1);t.set({cardsInHand:r})}});$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"startgame.php",type:"POST",data:{id:1,sts:1,aw:s,d1:r.models[0].get("cardsInHand"),d2:r.models[1].get("cardsInHand"),d3:r.models[2].get("cardsInHand"),d4:r.models[3].get("cardsInHand"),d5:r.models[4].get("cardsInHand"),d6:r.models[5].get("cardsInHand")},success:function(){n.View.getInstance().setStatusMessage("Start the game!")},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");t.addEventListener()}})});t.$("#detect-location").off("click");t.$("#detect-location").on("click",function(){n.View.getInstance().getMapView().updateMapToCurLocation()});t.$(".character-name").off("click");t.$(".character-name").on("click",function(){var i=$(this);$.ajax({url:n.Setting.getPhpDir()+"selectcharacter.php",type:"POST",data:{id:1,prevcharacter:n.Controller.getInstance().getCharacterId(),newcharacter:i.attr("id")},success:function(r){r==1?(n.Router.getInstance().navigate("setup/"+i.attr("id"),{trigger:!1,replace:!0}),n.Controller.getInstance().setCharacterId(i.attr("id"))):n.Controller.getInstance().getCharacterId()!=i.attr("id")&&t.setMessage("'"+t.$("#"+i.attr("id")).html()+"' is already taken.")},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");t.addEventListener()}})})},i.prototype.showSelectionMenu=function(t){var i=this,r,u;n.Controller.getInstance().bShowClaimLocation=!0;i.$("#claim-location").addClass("disabled");r=_.template(n.Setting.getInstance().getWingMakeGuessTemplate());u={locationId:t.get("id"),locationName:t.get("name"),characters:n.Controller.getInstance().getCharacters(),weapons:n.Controller.getInstance().getWeapons()};i.$("#panel-guess").html(r(u));i.addEventListener()},i.prototype.showSelectionResult=function(){var t=this,i,r,u,f,e,o,s,h,c;n.Controller.getInstance().bShowClaimLocation=!1;i=n.Controller.getInstance().getGame().get("sg").split(",");i!=undefined&&(t.$("#claim-location").addClass("disabled"),t.$("#accusation").addClass("disabled"),t.$("#panel-guess").html(""),r=_.template(n.Setting.getInstance().getWingShowSuggestionTemplate()),o=n.Controller.getInstance().getLocations(),$.each(o.models,function(n,t){t.get("id")==i[0]&&(u=t)}),s=n.Controller.getInstance().getCharacters(),$.each(s.models,function(n,t){t.get("id")==i[1]&&(f=t)}),h=n.Controller.getInstance().getWeapons(),$.each(h.models,function(n,t){t.get("id")==i[2]&&(e=t)}),c={message:"<b>"+n.Controller.getInstance().getGame().getCharacterMakingSuggestion().get("name")+"<\/b> suggested that <b>"+f.get("name")+"<\/b> commited a crime with a/an <b>"+e.get("name")+"<\/b> at <b>"+u.get("name")+"<\/b>"},t.$("#panel-show-suggestion").html(r(c)),t.addEventListener(),n.Controller.getInstance().bShowSuggestionResult=!0)},i.prototype.showSelectionShowCard=function(){var u=this,f,i,e,o,s;if(n.Controller.getInstance().bShowClaimLocation=!0,f=n.Controller.getInstance().getGame().get("sg").split(","),i=n.Controller.getInstance().getGame().getNextCardHolder(f),i==null)console.log("There is no player to show the card."),$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"winner.php",type:"POST",data:{id:1,character:n.Controller.getInstance().getCharacterId().charAt(1)},success:function(n){n==1},error:function(){n.View.getInstance().setStatusMessage("Unexpected Error. Please try again.");u.addEventListener()}});else if(i!=null&&i.get("id")==n.Controller.getInstance().getCharacterId()){var t=n.Controller.getInstance().getGame().getMatchCards(f,i.get("cardsInHand").split(",")),h=_.template(n.Setting.getInstance().getWingShowCardTemplate()),r=Array(),c=n.Controller.getInstance().getLocations();$.each(c.models,function(n,i){for(var u=0;u<t.length;u++)t[u]==i.get("id")&&r.push(i)});e=n.Controller.getInstance().getCharacters();$.each(e.models,function(n,i){for(var u=0;u<t.length;u++)t[u]==i.get("id")&&r.push(i)});o=n.Controller.getInstance().getWeapons();$.each(o.models,function(n,i){for(var u=0;u<t.length;u++)t[u]==i.get("id")&&r.push(i)});s={cards:r};u.$("#panel-show-card").html(h(s));u.addEventListener();n.Controller.getInstance().bShowCardShow=!0}},i.prototype.showSelectionShowCardResult=function(){var i=this,e,r,s,h,o,f;if(n.Controller.getInstance().bShowClaimLocation=!1,i.$("#claim-location").addClass("disabled"),i.$("#accusation").addClass("disabled"),i.$("#panel-guess").html(""),e=n.Controller.getInstance().getGame().get("sg").split(","),r=n.Controller.getInstance().getGame().getNextCardHolder(e),n.Controller.getInstance().getGame().get("cc")==parseInt(n.Controller.getInstance().getCharacterId()[1])){var o=_.template(n.Setting.getInstance().getWingShowCardResultTemplate1()),u=n.Controller.getInstance().getGame().get("sc"),t,c=n.Controller.getInstance().getLocations();$.each(c.models,function(n,i){u==i.get("id")&&(t=i)});s=n.Controller.getInstance().getCharacters();$.each(s.models,function(n,i){u==i.get("id")&&(t=i)});h=n.Controller.getInstance().getWeapons();$.each(h.models,function(n,i){u==i.get("id")&&(t=i)});f={message:"<b>"+r.get("name")+"<\/b> showed you a/an <b>"+t.get("name")+"<\/b> card."};$('input[type="checkbox"][data-card="'+t.get("id")+'"]').prop({checked:"checked"});$('input[type="text"][data-card="'+t.get("id")+'"]').val("From "+r.get("name")+".")}else o=_.template(n.Setting.getInstance().getWingShowCardResultTemplate2()),f={message:"<b>"+r.get("name")+"<\/b> showed a card to <b>"+n.Controller.getInstance().getGame().getCharacterMakingSuggestion().get("name")+"<\/b>."};i.$("#panel-show-suggestion").html(o(f));i.addEventListener();n.Controller.getInstance().bShowCardShowResult=!0},i.prototype.showClaimLocation=function(){var t=this;n.Controller.getInstance().bShowCardShow=!1;n.Controller.getInstance().bShowCardShowResult=!1;n.Controller.getInstance().bShowSuggestionResult=!1;t.$("#claim-location").removeClass("disabled");t.$("#accusation").removeClass("disabled");t.$("#panel-guess").html("");t.$("#panel-show-suggestion").html("");n.Controller.getInstance().bShowClaimLocation=!0},i.prototype.showWinner=function(){var i=this,c=_.template(n.Setting.getInstance().getWingShowWinnerTemplate()),r=n.Controller.getInstance().getCharacters().findWhere({id:"c"+n.Controller.getInstance().getGame().get("wn")+"s"}),t=n.Controller.getInstance().getGame().get("aw").split(","),u,f,e,l=n.Controller.getInstance().getLocations(),o,s,h;$.each(l.models,function(n,i){for(var r=0;r<t.length;r++)t[r]==i.get("id")&&(u=i)});o=n.Controller.getInstance().getCharacters();$.each(o.models,function(n,i){for(var r=0;r<t.length;r++)t[r]==i.get("id")&&(f=i)});s=n.Controller.getInstance().getWeapons();$.each(s.models,function(n,i){for(var r=0;r<t.length;r++)t[r]==i.get("id")&&(e=i)});h={message:"<b>"+r.get("name")+"<\/b> discovered the truth of the crime.<br/><b>"+f.get("name")+"<\/b> commited the crime at <b>"+u.get("name")+"<\/b> with <b>"+e.get("name")+"<\/b>"};i.$("#claim-location").addClass("disabled");i.$("#panel-show-suggestion").html(c(h));n.View.getInstance().setStatusMessage("<b>"+r.get("name")+"<\/b> wins the game.")},i}(Backbone.View);n.WingView=t}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(t){function i(i){var r,u,f;t.call(this,i);r=this;r.group=new L.LayerGroup;u=n.Controller.getInstance().getCharacters();u&&$.each(u.models,function(n,t){t.marker=null;t.circle=null});f=n.Controller.getInstance().getLocations();f!=undefined&&$.each(f.models,function(n,t){t.marker=null;t.circle=null});r.icons=[];r.icons.push(new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-scarlet.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)}));r.icons.push(new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-plum.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)}));r.icons.push(new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-peacock.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)}));r.icons.push(new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-green.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)}));r.icons.push(new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-mustard.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)}));r.icons.push(new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-black.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)}));r.buildingIcon=new L.Icon({iconUrl:n.Setting.getImageDir()+"marker-location2.png",shadowUrl:n.Setting.getImageDir()+"marker-shadow.png",iconSize:new L.Point(40,40),iconAnchor:new L.Point(20,40),shadowAnchor:new L.Point(9,38),popupAnchor:new L.Point(0,-40)})}return __extends(i,t),i.prototype.attachToMap=function(n){var t=this;t.group.addTo(n);console.log("group is attached to map")},i.prototype.render=function(){var t=this,r=n.Controller.getInstance().getCharacters(),i;$.each(r.models,function(n,i){if(i.get("bActive")==1)if(i.marker==undefined){i.marker=new L.Marker(new L.LatLng(parseFloat(i.get("latitude")),parseFloat(i.get("longitude"))),{icon:t.icons[n],draggable:!1,riseOnHover:!0}).bindLabel('<span class="character-'+(n+1)+'">'+i.get("name")+"<\/span>",{noHide:!0,direction:"auto"});t.group.addLayer(i.marker);i.marker.on("click",function(){this.openPopup();console.log("pop up")});console.log("new marker is created")}else i.marker.setLatLng(new L.LatLng(parseFloat(i.get("latitude")),parseFloat(i.get("longitude"))));else i.get("bActive")==0&&i.marker!=undefined&&t.group.hasLayer(i.marker)&&(t.group.removeLayer(i.marker),i.marker=null)});n.Controller.getInstance().gameStatus==2&&(i=n.Controller.getInstance().getLocations(),i!=undefined&&$.each(i.models,function(n,i){i.get("bActive")==1?i.marker==undefined?(i.marker=new L.Marker(new L.LatLng(parseFloat(i.get("latitude")),parseFloat(i.get("longitude"))),{icon:t.buildingIcon,draggable:!1,riseOnHover:!0}).bindLabel('<span class="location">'+i.get("name")+"<\/span>",{noHide:!0,direction:"left"}),t.group.addLayer(i.marker),console.log("new marker is created")):i.marker.setLatLng(new L.LatLng(parseFloat(i.get("latitude")),parseFloat(i.get("longitude")))):i.get("bActive")==0&&i.marker!=undefined&&t.group.hasLayer(i.marker)&&(t.group.removeLayer(i.marker),i.marker=null)}));t.addEventListener()},i.prototype.update=function(){this.render()},i.prototype.addEventListener=function(){var n=this},i}(Backbone.View);n.MarkerView=t}(LifeClue||(LifeClue={})),function(n){var t=function(){function n(){if(n._instance)throw new Error("Error: Instantiation failed: Use Model.getInstance() instead of new.");n._instance=this}return n.getInstance=function(){return n._instance},n._instance=new n,n}();n.Model=t}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(t){function i(i,r){t.call(this,i,r);this.url="gametable.php";this.url=n.Setting.getPhpDir()+this.url;this.defaults={id:0,sts:0,c0s:0,c1s:0,c2s:0,c3s:0,c4s:0,c5s:0,c6s:0,c1t:0,c1g:0,c2t:0,c2g:0,c3t:0,c3g:0,c4t:0,c4g:0,c5t:0,c5g:0,c6t:0,c6g:0}}return __extends(i,t),i.prototype.parse=function(n,i){return n.id!=null&&(n.id=parseInt(n.id)),n.sts=parseInt(n.sts),n.c0s=parseInt(n.c0s),n.c1s=parseInt(n.c1s),n.c2s=parseInt(n.c2s),n.c3s=parseInt(n.c3s),n.c4s=parseInt(n.c4s),n.c5s=parseInt(n.c5s),n.c6s=parseInt(n.c6s),n.c1t=parseFloat(n.c1t),n.c1g=parseFloat(n.c1g),n.c2t=parseFloat(n.c2t),n.c2g=parseFloat(n.c2g),n.c3t=parseFloat(n.c3t),n.c3g=parseFloat(n.c3g),n.c4t=parseFloat(n.c4t),n.c4g=parseFloat(n.c4g),n.c5t=parseFloat(n.c5t),n.c5g=parseFloat(n.c5g),n.c6t=parseFloat(n.c6t),n.c6g=parseFloat(n.c6g),n.r1=parseInt(n.r1),n.r2=parseInt(n.r2),n.r3=parseInt(n.r3),n.r4=parseInt(n.r4),n.r5=parseInt(n.r5),n.r6=parseInt(n.r6),n.cc=parseInt(n.cc),t.prototype.parse.call(this,n,i)},i.prototype.toJSON=function(){var n=this.clone().attributes;return this.id!=null&&(n.id=this.id),n},i.prototype.getNumPlayers=function(){for(var t=0,n=1;n<=6;n++)this.get("c"+n+"s")==1&&t++;return t},i.prototype.getCharacterMakingSuggestion=function(){return n.Controller.getInstance().getCharacters().findWhere({id:"c"+this.get("cc")+"s"})},i.prototype.getNextCardHolder=function(t){for(var o,i,e,r,u,s=this,h=s.getCharacterMakingSuggestion(),c=parseInt(h.get("id")[1]),f=1;f<=8;f++)if(o=mod(c+f,7),i=n.Controller.getInstance().getCharacters().findWhere({id:"c"+o+"s"}),i!=undefined)for(e=i.get("cardsInHand").split(","),r=0;r<t.length;r++)for(u=0;u<e.length;u++)if(t[r]==e[u])return i;return null},i.prototype.getMatchCards=function(n,t){for(var r,u=[],i=0;i<n.length;i++)for(r=0;r<t.length;r++)n[i]==t[r]&&u.push(n[i]);return u},i}(Backbone.Model),i;n.Game=t;i=function(i){function r(r,u){i.call(this,r,u);this.url="gametable.php";this.model=t;this.url=n.Setting.getPhpDir()+this.url}return __extends(r,i),r}(Backbone.Collection);n.GameTable=i}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(n){function t(t,i){n.call(this,t,i);this.defaults={id:0,name:"",bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""}}return __extends(t,n),t.prototype.parse=function(t,i){return t.id!=null&&(t.id=parseInt(t.id)),t.bActive=parseInt(t.bActive),t.latitude=parseFloat(t.latitude),t.longitude=parseFloat(t.longitude),n.prototype.parse.call(this,t,i)},t.prototype.toJSON=function(){var n=this.clone().attributes;return this.id!=null&&(n.id=this.id),n},t}(Backbone.Model),i;n.Character=t;i=function(n){function i(i,r){n.call(this,i,r);this.model=t}return __extends(i,n),i}(Backbone.Collection);n.Characters=i}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(n){function t(t,i){n.call(this,t,i);this.defaults={id:0,name:"",bActive:0,latitude:0,longitude:0,radius:0,bAnswer:0}}return __extends(t,n),t.prototype.parse=function(t,i){return t.id!=null&&(t.id=parseInt(t.id)),t.bActive=parseInt(t.bActive),t.latitude=parseFloat(t.latitude),t.longitude=parseFloat(t.longitude),t.radius=parseFloat(t.radius),n.prototype.parse.call(this,t,i)},t.prototype.toJSON=function(){var n=this.clone().attributes;return this.id!=null&&(n.id=this.id),n},t}(Backbone.Model),i;n.Location=t;i=function(n){function i(i,r){n.call(this,i,r);this.model=t}return __extends(i,n),i}(Backbone.Collection);n.Locations=i}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(n){function t(t,i){n.call(this,t,i);this.defaults={id:0,name:"",bAnswer:0}}return __extends(t,n),t.prototype.parse=function(t,i){return t.id!=null&&(t.id=parseInt(t.id)),n.prototype.parse.call(this,t,i)},t.prototype.toJSON=function(){var n=this.clone().attributes;return this.id!=null&&(n.id=this.id),n},t}(Backbone.Model),i;n.Weapon=t;i=function(n){function i(i,r){n.call(this,i,r);this.model=t}return __extends(i,n),i}(Backbone.Collection);n.Weapons=i}(LifeClue||(LifeClue={}));__extends=this.__extends||function(n,t){function r(){this.constructor=n}for(var i in t)t.hasOwnProperty(i)&&(n[i]=t[i]);r.prototype=t.prototype;n.prototype=new r},function(n){var t=function(){function t(){var r=this;if(this.updateFromServer=function(){var u=r,f=n.View.getInstance().getMapView().getLocation();f&&$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"updatelocation.php",type:"POST",data:{id:1,character:t.getInstance().getCharacterId().charAt(1),lat:f.lat,lng:f.lng},success:function(){},error:function(){console.log("error");u.updateFromServer()}});u.gameTable!=undefined&&u.gameTable.fetch({processData:!0,dataType:"json",timeout:1e4,data:{id:1},success:function(r){if($("#database-status").removeClass("hidden"),setTimeout(function(){$("#database-status").addClass("hidden")},500),r.models[0].get("sts")==0?t.getInstance().gameStatus!=1&&i.getInstance().navigate("setup/"+u.characterId,{trigger:!0,replace:!0}):r.models[0].get("sts")==1?t.getInstance().gameStatus!=2&&i.getInstance().navigate("game/"+u.characterId,{trigger:!0,replace:!0}):r.models[0].get("sts")==2&&t.getInstance().gameStatus!=3&&i.getInstance().navigate("result/"+u.characterId,{trigger:!0,replace:!0}),n.View.getInstance().getWingView().update(),u.updateCharacters(),setTimeout(function(){t.getInstance().updateFromServer()},3e3),u.isAutoFilled||setTimeout(function(){var n,i;$.each(u.characters.models,function(n,t){t.set({cardsInHand:u.getGame().get("d"+(n+1))})});n=t.getInstance().getYourCharacter();n!=undefined&&(i=n.get("cardsInHand").split(","),$.each(i,function(n,t){$('input[type="checkbox"][data-card="'+t+'"]').prop({checked:!0,disabled:!0});$('input[type="text"][data-card="'+t+'"]').prop({disabled:!0}).val("In your hand.")}),u.isAutoFilled=!0)},1500),u.getGame().get("wn")!=0?n.View.getInstance().getWingView().showWinner():u.getGame().get("cc")==0&&u.getGame().get("sg")==""&&u.getGame().get("sc")==""?u.bShowClaimLocation||setTimeout(function(){n.View.getInstance().getWingView().showClaimLocation()},1e3):u.getGame().get("cc")!=0&&u.getGame().get("sg")!=""&&u.getGame().get("sc")==""?(u.bShowSuggestionResult||setTimeout(function(){n.View.getInstance().getWingView().showSelectionResult()},1e3),u.bShowCardShow||setTimeout(function(){n.View.getInstance().getWingView().showSelectionShowCard()},2e3)):u.getGame().get("cc")!=0&&u.getGame().get("sg")!=""&&u.getGame().get("sc")!=""&&(u.bShowCardShowResult||setTimeout(function(){n.View.getInstance().getWingView().showSelectionShowCardResult()},1e3)),t.getInstance().gameStatus==1)$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"resetbrowsercache.php",type:"POST",data:{},success:function(){console.log("browser cache is resetted.")},error:function(){console.log("error.")}});else if(u.bFirstLoadingBrowserCache)u.bFirstLoadingBrowserCache=!1,$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"loadbrowsercache.php",type:"POST",data:{},success:function(n){var t;if(n!=""){t=0;$.each($('input[type="checkbox"]'),function(){t++});var r=n.substr(0,t),u=n.substr(t,n.length),i=u.split("|",t);$.each($('input[type="checkbox"]'),function(n,t){r.charAt(n)=="1"&&$(t).prop({checked:"checked"})});$.each($('input[type="text"]'),function(n,t){i[n]!=undefined&&$(t).val(i[n].trim())})}},error:function(){console.log("error.")}});else{var f="",o=!1,e=0;$.each($('input[type="checkbox"]'),function(n,t){$(t).prop("checked")==!0?(f+="1",o=!0):f+="0";e++});$.each($('input[type="text"]'),function(n,t){f+=$(t).val()+" |"});f=f.substr(0,f.length);o&&$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"updatebrowsercache.php",type:"POST",data:{checkbox:f,memo:""},success:function(n){var i=n.substr(0,e),r=n.substr(e,n.length),t=r.split("|",e);$.each($('input[type="checkbox"]'),function(n,t){i.charAt(n)=="1"&&$(t).prop({checked:"checked"})});$.each($('input[type="text"]'),function(n,i){t[n]!=undefined&&$(i).val(t[n].trim())})},error:function(){console.log("error.")}})}u.messageUpdate()},error:function(n,t,i){console.log(t);console.log(i);console.log("error while fetching data from the server.")}})},t._instance)throw new Error("Error: Instantiation failed: Use Controller.getInstance() instead of new.");t._instance=this;this.watchId=-1;this.isAutoFilled=!1;this.bShowSuggestionResult=!1;this.bShowCardShow=!1;this.bShowCardShowResult=!1;this.bShowClaimLocation=!1;this.bFirstLoadingBrowserCache=!0;this.gameStatus=0}return t.getInstance=function(){return t._instance},t.prototype.getWatchId=function(){return this.watchId},t.prototype.loadHomePage=function(){var t=this;navigator.geolocation.clearWatch(t.watchId);n.View.getInstance().loadBasePageLayout();n.View.getInstance().loadHomePageLayout();this.gameTable==undefined&&(this.gameTable=n.GameFactory.getInstance().create());this.characters==undefined&&(this.characters=n.CharacterFactory.getInstance().create());this.locations==undefined&&(this.locations=n.LocationFactory.getInstance().create());this.weapons==undefined&&(this.weapons=n.WeaponFactory.getInstance().create());t.intializeGeoWatch()},t.prototype.loadGamePage=function(){var t=this;navigator.geolocation.clearWatch(t.watchId);n.View.getInstance().loadBasePageLayout();n.View.getInstance().loadGamePageLayout();this.gameTable==undefined&&(this.gameTable=n.GameFactory.getInstance().create());this.characters==undefined&&(this.characters=n.CharacterFactory.getInstance().create());this.locations==undefined&&(this.locations=n.LocationFactory.getInstance().create());this.weapons==undefined&&(this.weapons=n.WeaponFactory.getInstance().create());t.intializeGeoWatch()},t.prototype.intializeGeoWatch=function(){var t=this;navigator.geolocation&&(t.watchId=navigator.geolocation.watchPosition(function(i){t.characterId!="c0s"&&($("#gps-status").removeClass("hidden"),setTimeout(function(){$("#gps-status").addClass("hidden")},500),n.View.getInstance().getMapView().setLocation(new L.LatLng(i.coords.latitude,i.coords.longitude)))},function(){t.intializeGeoWatch()},{enableHighAccuracy:!0,timeout:5e3,maximumAge:6e4}))},t.prototype.setCharacterId=function(n){this.characterId=n},t.prototype.getCharacterId=function(){return this.characterId},t.prototype.messageUpdate=function(){var i=this,u,r;t.getInstance().gameStatus==2&&(i.getGame().get("cc")!=0&&i.getGame().get("sg")!=""&&i.getGame().get("sc")==""?i.getGame().get("cc")==parseInt(i.getCharacterId()[1])?n.View.getInstance().setStatusMessage("You submit your suggestion. Please wait other's response."):n.View.getInstance().setStatusMessage("<b>"+i.getGame().getCharacterMakingSuggestion().get("name")+"<\/b> submitted his suggestion."):i.getGame().get("cc")!=0&&i.getGame().get("sg")!=""&&i.getGame().get("sc")!=""?(u=t.getInstance().getGame().get("sg").split(","),r=t.getInstance().getGame().getNextCardHolder(u),r!=undefined&&n.View.getInstance().setStatusMessage("<b>"+r.get("name")+"<\/b> showed a card to <b>"+i.getGame().getCharacterMakingSuggestion().get("name")+"<\/b>.")):i.getGame().get("cc")!=0&&i.getGame().get("cc")!=parseInt(i.getCharacterId()[1])&&i.getGame().getCharacterMakingSuggestion()!=null&&n.View.getInstance().setStatusMessage("<b>"+i.getGame().getCharacterMakingSuggestion().get("name")+"<\/b> is making a suggestion."))},t.prototype.getGame=function(){return this.gameTable==undefined?null:this.gameTable.models[0]},t.prototype.getCharacters=function(){return this.characters},t.prototype.updateCharacters=function(){for(var r=this,i=r.getGame(),t=1;t<=6;t++)r.characters.findWhere({id:"c"+t+"s"}).set({bActive:i.get("c"+t+"s"),latitude:i.get("c"+t+"t"),longitude:i.get("c"+t+"g")});n.View.getInstance().getMarkerView().update()},t.prototype.getLocations=function(){return this.locations},t.prototype.getWeapons=function(){return this.weapons},t.prototype.pickCrime=function(){var n=this;return n.characters.at(Math.floor(Math.random()*n.characters.models.length)).set({bAnswer:1}),n.locations.at(Math.floor(Math.random()*n.characters.models.length)).set({bAnswer:1}),n.weapons.at(Math.floor(Math.random()*n.characters.models.length)).set({bAnswer:1}),console.log("Criminal: "+n.characters.findWhere({bAnswer:1}).get("name")),console.log("Location: "+n.locations.findWhere({bAnswer:1}).get("name")),console.log("Weapon: "+n.weapons.findWhere({bAnswer:1}).get("name")),n.locations.findWhere({bAnswer:1}).get("id")+","+n.characters.findWhere({bAnswer:1}).get("id")+","+n.weapons.findWhere({bAnswer:1}).get("id")},t.prototype.getYourCharacter=function(){return this.characters.findWhere({id:this.characterId})},t._instance=new t,t}(),i;n.Controller=t;i=function(i){function r(n){if(r._instance)throw new Error("Error: Instantiation failed: Use Router.getInstance() instead of new.");r._instance=this;this.routes={"":"home","setup/:id":"setup","game/:id":"game","result/:id":"result",reset:"reset",status:"status"};i.call(this,n)}return __extends(r,i),r.getInstance=function(){return r._instance},r.prototype.home=function(){this.navigate("setup/c0s",{trigger:!0,replace:!0})},r.prototype.setup=function(i){console.log("we have loaded the setup page with id: "+i);t.getInstance().setCharacterId(i.toString());n.Controller.getInstance().loadHomePage();t.getInstance().gameStatus=1},r.prototype.game=function(i){console.log("we have loaded the game page with id: "+i);t.getInstance().isAutoFilled=!1;t.getInstance().setCharacterId(i.toString());n.Controller.getInstance().loadGamePage();t.getInstance().gameStatus=2},r.prototype.result=function(n){console.log("we have loaded the result page with id: "+n);t.getInstance().setCharacterId(n.toString())},r.prototype.reset=function(){isResetting=!0;$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"resetgame.php",type:"POST",data:{id:1},success:function(n){n==1&&alert("game is reseted")},error:function(){alert("failed to reset the game.")}})},r.prototype.status=function(){isResetting=!0;console.log("!");var t="";t+="<div>1) Kitchen, 2) Lounge, 3) Library, 4) Dining Room, 5) Hall, 6) Cellar, 7) Conservatory, 8) Ballroom<\/div><hr>";t+="<div>1) Miss Scarlett, 2) Professor Plum, 3) Mrs.Peacock, 4) Reverend Green, 5) Colonel Mustard, 6) Mrs.Black<\/div><hr>";t+="<div>1) Candlestick, 2) Poison, 3) Rope, 4) Gloves, 5) Horseshoe, 6) Knife, 7) Lead Pipe<\/div><hr>";$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"gamestatistic.php",type:"GET",data:{id:1},success:function(n){t+=n;console.log(t);$("#view-main").html(t);$("hr").css({"margin-top":"2px"});$("#view-main").css({"text-align":"left","font-size":"small","overflow-y":"scroll"})},error:function(){}});setTimeout(function(){$.ajax({timeout:1e4,url:n.Setting.getPhpDir()+"gamestatistic.php",type:"GET",data:{id:1},success:function(n){t+=n;console.log(t);$("#view-main").html(t);$("#view-main").css({"text-align":"left","font-size":"small","overflow-y":"scroll"})},error:function(){}})},3e4)},r._instance=new r,r}(Backbone.Router);n.Router=i}(LifeClue||(LifeClue={})),function(n){var t=function(){function n(){if(n._instance)throw new Error("Error: Instantiation failed: Use Setting.getInstance() instead of new.");n._instance=this}return n.getInstance=function(){return n._instance},n.setBaseUrl=function(t){n._instance.baseUrl=t},n.getBaseUrl=function(){return n._instance.baseUrl},n.getPhpDir=function(){return n.getBaseUrl()+"core/php/"},n.getImageDir=function(){return n.getBaseUrl()+"core/image/"},n.prototype.getSiteName=function(){return"LifeClue"},n.prototype.getStartGameText=function(){return"Start Game"},n.prototype.getClaimLocationText=function(){return"Claim Location"},n.prototype.nonAvailableText=function(){return""},n.prototype.getDetectGeoLocationText=function(){return"Show My Location"},n.prototype.getSelectYourCharacterText=function(){return"Select Your Character"},n.prototype.getCharacter1Name=function(){return"Miss Scarlett"},n.prototype.getCharacter2Name=function(){return"Professor Plum"},n.prototype.getCharacter3Name=function(){return"Mrs. Peacock"},n.prototype.getCharacter4Name=function(){return"Reverend Green"},n.prototype.getCharacter5Name=function(){return"Colonel Mustard"},n.prototype.getCharacter6Name=function(){return"Mrs. Black"},n.prototype.getPageBaseLayoutTemplate=function(){var n="";return n+='<div id="wrapper-nav"><\/div>',n+='<div id="wrapper-page">',n+='<div id="wrapper-body">',n+='<div id="panel-status"><%= status %><\/div>',n+='<div id="panel-body"><\/div>',n+='<div id="panel-wing"><\/div>',n+="<\/div>",n+='<div id="wrapper-header"><%= title %><div id="gps-status"><\/div><div id="database-status"><\/div><div id="menu-header"><\/div><\/div>',n+"<\/div>"},n.prototype.getMapBasicControlLayoutTemplate=function(){var n="";return n+='<div class="leaflet-control">',n+='<div class="control-button locate"><\/div>',n+"<\/div>"},n.prototype.getWingCharacterSelectTemplate=function(){var n="";return n+='<div class="col-xs-12 col-left-padding">',n+='<button type="button" id="detect-location" class="btn btn-default"><%= detect %><\/button>',n+="<\/div>",n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h1"><span class="glyphicon glyphicon-user" aria-hidden="true"><\/span> <%= select %><\/div>',n+="<\/div>",n+='<button type="button" id="c1s" class="btn btn-default transparent character-name character-1"><%= character1 %><\/button>',n+='<button type="button" id="c2s" class="btn btn-default transparent character-name character-2"><%= character2 %><\/button>',n+='<button type="button" id="c3s" class="btn btn-default transparent character-name character-3"><%= character3 %><\/button>',n+='<button type="button" id="c4s" class="btn btn-default transparent character-name character-4"><%= character4 %><\/button>',n+='<button type="button" id="c5s" class="btn btn-default transparent character-name character-5"><%= character5 %><\/button>',n+='<button type="button" id="c6s" class="btn btn-default transparent character-name character-6"><%= character6 %><\/button>',n+='<div class="col-xs-12">',n+='<div class="wing-h2"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"><\/span> <span id="message"><%= message %><\/span><\/div>',n+="<\/div>",n+='<div class="col-xs-12">',n+='<button type="button" id="start-game" class="btn btn-default hidden"><%= start %><\/button>',n+="<\/div>",n+='<div class="col-xs-12">',n+"<\/div>"},n.prototype.getWingPlayNoteTemplate=function(){var n="";return n+='<div class="col-xs-12 col-left-padding">',n+='<button type="button" id="claim-location" class="btn btn-default"><%= location %><\/button>',n+="<\/div>",n+='<div id="panel-show-suggestion">',n+="<\/div>",n+='<div id="panel-guess">',n+="<\/div>",n+='<div class="col-xs-12">',n+="<hr>",n+="<\/div>",n+='<div class="col-xs-12">',n+='<div class="wing-h1"><span class="glyphicon glyphicon-ok" aria-hidden="true"><\/span> Check List<\/div>',n+="<\/div>",n+="<% _.each(locations.models, function (location) { %>",n+='<div class="form-group">',n+='<div class="col-xs-6 layer-checkbox layer-checkbox-header">',n+='<label class="label-header"><input type="checkbox" data-card="<%= location.get("id") %>">&nbsp <%= location.get("name") %><\/label>',n+="<\/div>",n+='<div class="col-xs-6">',n+='<input type="text" data-card="<%= location.get("id") %>"><\/input>',n+="<\/div>",n+="<\/div>",n+="<% }); %>",n+='<div class="col-xs-12">',n+="<hr>",n+="<\/div>",n+="<% _.each(characters.models, function (character) { %>",n+='<div class="form-group">',n+='<div class="col-xs-6 layer-checkbox layer-checkbox-header">',n+='<label class="label-header"><input type="checkbox" data-card="<%= character.get("id") %>">&nbsp <%= character.get("name") %><\/label>',n+="<\/div>",n+='<div class="col-xs-6">',n+='<input type="text" data-card="<%= character.get("id") %>"><\/input>',n+="<\/div>",n+="<\/div>",n+="<% }); %>",n+='<div class="col-xs-12">',n+="<hr>",n+="<\/div>",n+="<% _.each(weapons.models, function (weapon) { %>",n+='<div class="form-group">',n+='<div class="col-xs-6 layer-checkbox layer-checkbox-header">',n+='<label class="label-header"><input type="checkbox" data-card="<%= weapon.get("id") %>">&nbsp <%= weapon.get("name") %><\/label>',n+="<\/div>",n+='<div class="col-xs-6">',n+='<input type="text" data-card="<%= weapon.get("id") %>"><\/input>',n+="<\/div>",n+="<\/div>",n+="<% }); %>",n+='<div class="col-xs-12">',n+="<hr>",n+"<\/div>"},n.prototype.getWingShowSuggestionTemplate=function(){var n="";return n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h2"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"><\/span> <span><%= message %><\/span><\/div>',n+="<\/div>",n+='<div id="panel-show-card">',n+"<\/div>"},n.prototype.getWingShowWinnerTemplate=function(){var n="";return n+='<div class="col-xs-12 col-top-padding">',n+="<\/div>",n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h1"><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"><\/span> Winner<\/div>',n+="<\/div>",n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h2"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"><\/span> <span><%= message %><\/span><\/div>',n+="<\/div>",n+='<div id="panel-show-card">',n+"<\/div>"},n.prototype.getWingShowCardTemplate=function(){var n="";return n+='<div class="form-group">',n+='<label for="show-card" class="col-xs-3 control-label">Card<\/label>',n+='<div class="col-xs-9">',n+='<select id="show-card" class="selectpicker">',n+="<% _.each(cards, function (card) { %>",n+='<option data-card="<%= card.get("id") %>"><%= card.get("name") %><\/option>',n+="<% }); %>",n+="<\/select>",n+="<\/div>",n+="<\/div>",n+='<div class="col-xs-12">',n+='<button type="button" id="submit-show-card" class="btn btn-default">Show Card<\/button>',n+"<\/div>"},n.prototype.getWingShowCardResultTemplate1=function(){var n="";return n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h2"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"><\/span> <span><%= message %><\/span><\/div>',n+="<\/div>",n+='<div class="col-xs-12">',n+='<button type="button" id="finish-turn" class="btn btn-default">Finish Your Turn<\/button>',n+"<\/div>"},n.prototype.getWingShowCardResultTemplate2=function(){var n="";return n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h2"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"><\/span> <span><%= message %><\/span><\/div>',n+"<\/div>"},n.prototype.getWingMakeGuessTemplate=function(){var n="";return n+='<div class="col-xs-12 col-top-padding">',n+='<div class="wing-h1"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"><\/span> Make Suggestion<\/div>',n+="<\/div>",n+='<div class="form-group">',n+='<label for="guess-location" class="col-xs-3 control-label">Location<\/label>',n+='<div class="col-xs-9">',n+='<select id="guess-location" class="selectpicker">',n+='<option data-card="<%= locationId %>"><%= locationName %><\/option>',n+="<\/select>",n+="<\/div>",n+="<\/div>",n+='<div class="form-group">',n+='<label for="guess-suspect" class="col-xs-3 control-label">Suspect<\/label>',n+='<div class="col-xs-9">',n+='<select id="guess-suspect" class="selectpicker">',n+="<option>None<\/option>",n+="<% _.each(characters.models, function (character) { %>",n+='<option data-card="<%= character.get("id") %>"><%= character.get("name") %><\/option>',n+="<% }); %>",n+="<\/select>",n+="<\/div>",n+="<\/div>",n+='<div class="form-group">',n+='<label for="guess-weapon" class="col-xs-3 control-label">Weapon<\/label>',n+='<div class="col-xs-9">',n+='<select id="guess-weapon" class="selectpicker">',n+="<option>None<\/option>",n+="<% _.each(weapons.models, function (weapon) { %>",n+='<option data-card="<%= weapon.get("id") %>"><%= weapon.get("name") %><\/option>',n+="<% }); %>",n+="<\/select>",n+="<\/div>",n+="<\/div>",n+='<div class="col-xs-12">',n+='<button type="button" id="submit-guess" class="btn btn-default">Submit Guess<\/button>',n+="<\/div>",n+='<div class="col-xs-12">',n+"<\/div>"},n.prototype.getTileMapAddress=function(){return"http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"},n.prototype.getDefaultZoomLevel=function(){return 19},n.prototype.getMinZoomLevel=function(){return 17},n.prototype.getMaxZoomLevel=function(){return 19},n.prototype.getWingViewShowDelay=function(){return 500},n.prototype.getStatusMessageDuration=function(){return 1e4},n._instance=new n,n}();n.Setting=t}(LifeClue||(LifeClue={})),function(n){var t=function(){function t(){if(t._instance)throw new Error("Error: Instantiation failed: Use MapFactory.getInstance() instead of new.");t._instance=this}return t.getInstance=function(){return t._instance},t.prototype.create=function(t,i){return new n.MapView(t,{el:i})},t._instance=new t,t}();n.MapFactory=t}(LifeClue||(LifeClue={})),function(n){var t=function(){function t(){if(t._instance)throw new Error("Error: Instantiation failed: Use WingFactory.getInstance() instead of new.");t._instance=this}return t.getInstance=function(){return t._instance},t.prototype.create=function(t,i){return new n.WingView(t,{el:i})},t._instance=new t,t}();n.WingFactory=t}(LifeClue||(LifeClue={})),function(n){(function(n){n[n.NONE=0]="NONE";n[n.READY=1]="READY";n[n.PLAY=2]="PLAY";n[n.END=3]="END";n[n.RESET=4]="RESET"})(n.GameStatus||(n.GameStatus={}));var i=n.GameStatus,t=function(){function t(){if(t._instance)throw new Error("Error: Instantiation failed: Use GameFactory.getInstance() instead of new.");t._instance=this}return t.getInstance=function(){return t._instance},t.prototype.create=function(){return new n.GameTable},t._instance=new t,t}();n.GameFactory=t}(LifeClue||(LifeClue={})),function(n){var t=function(){function t(){if(t._instance)throw new Error("Error: Instantiation failed: Use CharacterFactory.getInstance() instead of new.");t._instance=this}return t.getInstance=function(){return t._instance},t.prototype.create=function(){var t=new n.Characters;return t.add(new n.Character({id:"c1s",name:n.Setting.getInstance().getCharacter1Name(),bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""})),t.add(new n.Character({id:"c2s",name:n.Setting.getInstance().getCharacter2Name(),bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""})),t.add(new n.Character({id:"c3s",name:n.Setting.getInstance().getCharacter3Name(),bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""})),t.add(new n.Character({id:"c4s",name:n.Setting.getInstance().getCharacter4Name(),bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""})),t.add(new n.Character({id:"c5s",name:n.Setting.getInstance().getCharacter5Name(),bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""})),t.add(new n.Character({id:"c6s",name:n.Setting.getInstance().getCharacter6Name(),bActive:0,latitude:0,longitude:0,bAnswer:0,cardsInHand:""})),t},t._instance=new t,t}();n.CharacterFactory=t}(LifeClue||(LifeClue={})),function(n){var t=function(){function t(){if(t._instance)throw new Error("Error: Instantiation failed: Use LocationFactory.getInstance() instead of new.");t._instance=this}return t.getInstance=function(){return t._instance},t.prototype.create=function(){var t=new n.Locations;return t.add(new n.Character({id:"l1",name:"Gilbert Library",bActive:1,latitude:33.774068568955222,longitude:-84.3955671787262,radius:.00015,bAnswer:0})),t.add(new n.Character({id:"l2",name:"Smith Building",bActive:1,latitude:33.773658330935895,longitude:-84.395336508750916,radius:.00015,bAnswer:0})),t.add(new n.Character({id:"l3",name:"Tech Green",bActive:1,latitude:33.774148832685754,longitude:-84.397074580192566,radius:.00015,bAnswer:0})),t.add(new n.Character({id:"l4",name:"Bus Stop",bActive:1,latitude:33.773225795244585,longitude:-84.3968653678894,radius:.00015,bAnswer:0})),t.add(new n.Character({id:"l5",name:"Skiles Building",bActive:1,latitude:33.773867909299881,longitude:-84.395940005779281,radius:.00015,bAnswer:0})),t.add(new n.Character({id:"l6",name:"Crosland Tower",bActive:1,latitude:33.773988305149494,longitude:-84.395175576210036,radius:.00015,bAnswer:0})),t.add(new n.Character({id:"l7",name:"Clough Commons",bActive:1,latitude:33.774153291779683,longitude:-84.396543502807617,radius:.00015,bAnswer:0})),t},t._instance=new t,t}();n.LocationFactory=t}(LifeClue||(LifeClue={})),function(n){var t=function(){function t(){if(t._instance)throw new Error("Error: Instantiation failed: Use WeaponFactory.getInstance() instead of new.");t._instance=this}return t.getInstance=function(){return t._instance},t.prototype.create=function(){var t=new n.Weapons;return t.add(new n.Character({id:"w1",name:"Candlestick",bAnswer:0})),t.add(new n.Character({id:"w2",name:"Poison",bAnswer:0})),t.add(new n.Character({id:"w3",name:"Rope",bAnswer:0})),t.add(new n.Character({id:"w4",name:"Gloves",bAnswer:0})),t.add(new n.Character({id:"w5",name:"Horseshoe",bAnswer:0})),t.add(new n.Character({id:"w6",name:"Knife",bAnswer:0})),t.add(new n.Character({id:"w7",name:"Lead Pipe",bAnswer:0})),t},t._instance=new t,t}();n.WeaponFactory=t}(LifeClue||(LifeClue={}));isResetting=!1;$(document).ready(function(){var n=window.location;LifeClue.Setting.setBaseUrl(n.origin+window.location.pathname);LifeClue.View.setElement({el:$("#view-main")});Backbone.history.start();isResetting||setTimeout(function(){LifeClue.Controller.getInstance().updateFromServer()},5e3)});
//# sourceMappingURL=lifeclue.min.js.map
